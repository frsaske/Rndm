...
const { trackCommand, initPresenceTracker } = require('./commands/track');
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        await require('./commands/autoreact').handleAutoreact(sock, message);
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.autoreact'):
                await require('./commands/autoreact').autoreactCommand(sock, chatId, message, userMessage.split(' ').slice(1));
                commandExecuted = true;
                break;
